    ...
    pdf.add(
      new Table([
        ...
        [
          ...
          new Cell(new Txt(' Supervisar la correcta aplicación de los procedimientos que involucran controles de los aspectos ambientales signifcativos y de riesgos de las actividades propias de las operaciones y procesos de la Planta de Distribución.').end).colSpan(3).end,
          new Cell(new Txt(' ').end).end,
          new Cell(new Txt(' ').end).end
        ],
        [
